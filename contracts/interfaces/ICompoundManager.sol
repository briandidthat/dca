...
interface ICompoundManager {
  ...
  function supplyStablecoin(address underlying, uint256 amount, address owner) external returns (uint256);
  function redeemStablecoin(address _cToken, uint256 _amount, address _owner) external;
}